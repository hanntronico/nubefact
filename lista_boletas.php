...
<head>
	...
	<title>BOLETAS Electrónicas - UDCH</title>
...
?>
 		...
 		<div id="fra_opciones" class="row">
 			<div class="col-md-12">
 				<input type="date" id="fecini" name="fecini" value="<?php echo $fec_hoy; ?>">
 				<input type="date" id="fecfin" name="fecfin" value="<?php echo $fec_hoy; ?>">
 				<input type="hidden" id="tipocomp" name="tipocomp" value="B">
